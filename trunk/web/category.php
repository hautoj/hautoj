...
///////////////////////////MAIN	
	...
	if (!$result){
		...
		foreach ($category as $cat){
			...
			$view_category.= "<a class='label label-$label_theme' style='display: inline-block; margin-right: 4px; margin-bottom: 4px;' href='problemset.php?search=".htmlentities(urlencode($cat),ENT_QUOTES,'utf-8')."'>".htmlentities($cat,ENT_QUOTES,'utf-8')."</a>&nbsp;";
